...
Local Scope
    ...
    Function variables are only active while the function is executing
    with nested blocks inner blocks can "see" and outer blocks can not "see"

Static Local Variables
    Declared with static qualifier
    Value is prefered between function calls
